...
function selectgame(td) {
  ...
  if (!gameboardselected.classList.contains("filled")) {
    ...
    PTc=PTc-1;
    PTricount.innerHTML= PTc;
if (PTc<1){toplace.classList.add("PUnav")}
}
      else {gameboardselected.innerHTML = "<img src='imgs/OTriangle.png'/>"
    OTc=OTc-1;
    if (OTc<1){toplace.classList.add("OUnav")}}
      token = "triangle";
    ...
    if (
      ...
      !gameboardselected.classList.contains("circle")
        ...
        if (player1turn==true) { gameboardselected.innerHTML = "<img src='imgs/PCircle.png'/>"
    PCic=PCic-1;
if (PCic<1){toplace.classList.add("PUnav")}}
        else {gameboardselected.innerHTML = "<img src='imgs/OCircle.png'/>"
    OCic=OCic-1;
    if (OCic<1){toplace.classList.add("OUnav")}}
      token = "circle";
    ...
    if (
      ...
      !gameboardselected.classList.contains("cross")
        ...
        if (player1turn==true) { gameboardselected.innerHTML = "<img src='imgs/PCross.png'/>";
    PCrc=PCrc-1;
if(PCrc<1){toplace.classList.add("PUnav")}}
        else {gameboardselected.innerHTML = "<img src='imgs/OCross.png'/>"
    OCrc=OCrc-1;
if(OCrc<1){toplace.classList.add("OUnav")}}
      token = "cross";
    ...
    if (
      ...
      !gameboardselected.classList.contains("square")
        ...
        if (player1turn==true) { gameboardselected.innerHTML = "<img src='imgs/PSquare.png'/>";
    PSc=PSc-1;
if (PSc<1){toplace.classList.add("PUnav")}}
        else {gameboardselected.innerHTML = "<img src='imgs/OSquare.png'/>"
    OSc=OSc-1;
if (OSc<1){toplace.classList.add("OUnav")}}
      token = "square";
    ...
    if (r1==4||r2==4||r3==4||r4==4||c1==4||c2==4||c3==4||c4==4||qu1==4||qu2==4||qu3==4||qu4==4){
    ...
    r1=0; r2=0; r3=0, r4=0; c1=0; c2=0; c3=0; c4=0; qu1=0; qu2=0; qu3=0; qu4=0; 
    if (player1turn==true){
        player1turn=false;
        player2turn=true;
    }else {
